...
<head>
    ...
    <style>
        /* Media queries to make my questions responsive */
...
<body>
    ...
    <section class="hero is-fullheight">
        ...
        <!-- Webpage container starts here  -->
        <div class="container">

        <?php
                // Array containing the qustions with the options and the answer starts here
                $questions = array(
                    1 => array(
        ...
        <!-- Webpage container ends here  -->

        <!-- Using session to move questions array -->
